...
public class RSA {
	...
	public static String getPublicKey(Map<String, Object> paramMap) throws UnsupportedEncodingException {
		...
		return Base64Encoder.encodeToString(localKey.getEncoded(), Base64Encoder.DEFAULT);
	}
	...
	public static String sign(byte[] data, String privateKey) throws Exception {
		byte[] keyBytes = Base64Encoder.decode(privateKey, Base64Encoder.DEFAULT);
		...
		return Base64Encoder.encodeToString(signature.sign(), Base64Encoder.DEFAULT);
	}
	...
	public static boolean verify(byte[] data, String publicKey, String sign) throws Exception {
		byte[] keyBytes = Base64Encoder.decode(publicKey, Base64Encoder.DEFAULT);
		...
		signature.update(data);
		return signature.verify(Base64Encoder.decode(sign, Base64Encoder.DEFAULT));
	}

	public static byte[] decryptByPrivateKey(byte[] encryptedData, String privateKey) throws Exception {
		byte[] arrayOfByte = Base64Encoder.decode(privateKey, Base64Encoder.DEFAULT);
	...
	public static byte[] decryptByPublicKey(byte[] encryptedData, String publicKey, int paramInt) throws Exception {
		byte[] arrayOfByte = Base64Encoder.decode(publicKey, Base64Encoder.DEFAULT);
	...
	public static byte[] encryptByPrivateKey(byte[] dataTobeEncrypt, String privateKey, int paramInt) throws Exception {
		byte[] privateKeyBytes = Base64Encoder.decode(privateKey.getBytes(), Base64Encoder.DEFAULT);
		KeyFactory localKeyFactory = KeyFactory.getInstance(ALGORITHM_RSA);
	...
	public static byte[] encryptByPublicKey(byte[] dataTobeEncrypt, String publicKey, int paramInt) throws Exception {
		byte[] publicKeyBytes = Base64Encoder.decode(publicKey, Base64Encoder.DEFAULT);
		KeyFactory localKeyFactory = KeyFactory.getInstance(ALGORITHM_RSA);
